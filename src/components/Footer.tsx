import { Users, Mail, MessageSquare, Linkedin } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {[
                {
                  href: "https://www.linkedin.com/in/matheusarjc",
                  icon: <Linkedin className="w-4 h-4" />,
                  label: "/in/matheusarjc",
                  external: true,
                },
                {
                  href: "https://github.com/matheusarjc",
                  icon: (
                ...
                {
                  href: "mailto:carvalhom630@gmail.com",
                  icon: <Mail className="w-4 h-4" />,
                  label: "carvalhom630@gmail.com",
                  external: false,
                },
                /* {
                ...
                <a
                  ...
                  className="flex items-center gap-3 text-muted-foreground hover:translate-x-2 transition-all duration-300 rounded-sm group relative p-2 -m-2 hover:bg-accent/5"
                  style={{ animationDelay: `${index * 0.1}s` }}>
